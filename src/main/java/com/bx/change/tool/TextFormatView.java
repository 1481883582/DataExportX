...
public class TextFormatView extends JRootPane {
    ...
    private void doInitMenu() {
        ...
        // 转换之前
        JComboBox<ToolMenu> changeBeforeMenu = new ComboBox<>(new ToolMenu[]{ToolMenu.SQl_MYSQL, ToolMenu.SQl_OSRDB});
        changeBeforeMenu.addItemListener(subMenuItemListener);
        changeBeforeMenu.setVisible(false);

        // 转换之后
        JComboBox<ToolMenu> changeAfterMenu = new ComboBox<>(new ToolMenu[]{ToolMenu.SQl_MYSQL, ToolMenu.SQl_OSRDB});
        changeAfterMenu.addItemListener(subMenuItemListener);
        changeAfterMenu.setVisible(false);
...
//        panel.add(changeBeforeMenu);
        panel.add(format);
//        panel.add(changeAfterMenu);
